  ...
  return (
    <>
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-green md:w-full">
        <a href="https://www.facebook.com/abhijeetpalanki" target="_blank">
          <AiFillFacebook className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://www.instagram.com/abhi.your.pal/" target="_blank">
          <AiFillInstagram className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://github.com/abhijeetpalanki" target="_blank">
          <AiFillGithub className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://www.linkedin.com/in/abhijeetpalanki/" target="_blank">
